        ...
        {!this.props.firebase.isLoggedIn && (
          <div className="demo-message">
            ...
            <div className="instructions">
              ...
              <li>
                There is an edit icon on each card for updating trip details
              </li>
              <li>There is a delete icon on each card for deleting a trip</li>
              <li>
                Each card provides information on : weather, and local
                information for a set of local places of interest
              </li>
              ...
              <li>
                Add destination: add a new travel destination and create a new
                trip card
              </li>
              ...
              <li>
                For a new trip, the user is required to specify the travel date
                and the destination country and airport
              </li>
              <li>
                The user can choose to specify places of interest when adding
                the trip or by using the edit icon when a new trip card is
                created
              </li>
              <p></p>
            </div>
